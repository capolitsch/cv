...
{\Large\bf Collin Politsch, Ph.D.} & \vspace{0.025cm}
\end{tabular*}

\begin{tabular*}{6.65in}{l@{\extracolsep{\fill}}r}
Born: Shawnee, Kansas & Kavli Institute for Cosmology \\
Citizenship: American & University of Cambridge \\
Email: collin.politsch@ast.cam.ac.uk & Madingley Road \\
Personal webpage: \myhref{https://collinpolitsch.com}{https://collinpolitsch.com} & Cambridge, CB3 0HA, U.K. \\
%U.K. Tier I Global Talent Visa (through Sep 2027)
%Last updated: \today 
\end{tabular*}
...
{\justify
\begin{itemize}[leftmargin=0.1cm, rightmargin=0.1cm]
\item[] {\bf Data Science, Statistics, Machine Learning:} 
Massive spatial datasets, spatial modeling, distributed spatial models, time series analysis, signal processing, forecasting, data mining, nonparametric statistics, uncertainty quantification, high-dimensional statistics, statistical machine learning
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\heading{Positions and Affiliations}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{0.025cm}

\begin{itemize}[leftmargin=0.05cm, rightmargin=0cm, itemsep=0.25cm]
\item[] \subheadingthreelines{{\bf University of Cambridge}}{Cambridge, U.K.}{{Postdoc Research Associate}, Kavli Institute for Cosmology \& Institute of Astronomy}{Sep 2022 -- pres}{{Adjunct Lecturer in Data Science}, Dept. of Applied Mathematics and Theoretical Physics}{Jan 2023 -- pres} %Sep 2023
%\item[] \subheadingtwolines{{\bf Flatiron Institute}}{New York, NY}{{Guest Researcher}, Center for Computational Astrophysics}{July 2021 -- May 2022}
\item[] \subheadingthreelines{{\bf Carnegie Mellon University}}{Pittsburgh, PA}{{Postdoctoral Fellow}, Machine Learning Department}{July 2020 -- Aug 2021}{Head of COVID-19 Forecasting, The Delphi Group}{}
\item[] \subheadingtwolines{{\bf Uber Technologies, Inc.}}{San Francisco, CA}{{Data Scientist Intern}, UberEverything Data Science}{June 2018 -- Aug 2018}
\end{itemize}
...
\item {\bf Flight of the Bumblebee: the Early Excess Flux of Type Ia Supernova 2023bee revealed by TESS, Swift and Young Supernova Experiment Observations}
\item[] Q. Wang, A. Rest, G. Dimitriadis, R. Ridden-Harper, et al. 
\item[] Submitted to {\it The Astrophysical Journal}. 
\item[] [\href{https://arxiv.org/abs/2305.03779}{arXiv}]

\vspace{0.5cm}

\item {\bf Photometric and Spectroscopic Analysis of SN 2022oqm: Closing The Gap Between SNe-Iax and Ic-like Calcium-Rich Transients}
\item[] S.K. Yadavalli et al.
\item[] Preparing to submit to {\it The Astrophysical Journal}. 
%\item[] [\href{https://arxiv.org/abs/2211.07128}{arXiv}]
...
\item[] {\it CHANCE}, Volume 32, Issue 3, September 2019. 
...
\item[] \hspace{-2ex}\subheadingthreelines{\bf University of Cambridge}{}{{\it Instructor}}{}{Department of Applied Mathematics and Theoretical Physics}{}
\begin{itemize}[leftmargin=0.4cm, rightmargin=0cm]
\item {\it Mathematical Foundations of Data-Intensive Science} \hfill 01/2023 -- pres
\begin{itemize}
\item[--] £1 million contract (in the first instance) to construct and deliver a corporate data science training course for a very large tech company partner. Expected to be renewed for 3+ additional years.
\end{itemize}
\end{itemize}
\end{itemize}
...
\item Postdoc representative on the Equality, Diversity \& Inclusion Committee [\myhref{https://www.ast.cam.ac.uk/about/equality.diversity.inclusion}{Link}] \hspace*{\fill}10/2022 -- pres\\
Institute of Astronomy, University of Cambridge. 
\item Co-Chair of the EDI Work-Life Balance focus group\hspace*{\fill}10/2022 -- pres\\
Institute of Astronomy, University of Cambridge. 
\item Postdoc representative on the Institute of Physics Project Juno Self-Assessment Team\hspace*{\fill}10/2022 -- pres\\ 
Institute of Astronomy, University of Cambridge.
\end{itemize}
...
{\bf Delphi} \tabto*{1in} Delphi Group [\myhref{https://delphi.cmu.edu/}{Link}] \hspace*{\fill} 08/2020 -- 08/2021
\vspace{0.2cm}
...
{\bf LSST} \tabto*{1in} \textit{Large Synoptic Survey Telescope (Vera C. Rubin Observatory)} [\myhref{https://www.lsst.org/}{Link}] \hspace*{\fill} 01/2023 -- pres
\vspace{0.2cm}
...
{\bf WEAVE} \tabto*{1in} \textit{William Herschel Telescope Enhanced Area Velocity Explorer} [\myhref{https://ingconfluence.ing.iac.es/confluence/display/WEAV/The+WEAVE+Project}{Link}] \hspace*{\fill} 01/2023 -- pres
\vspace{0.2cm}
...
{\bf YSE} \tabto*{1in} \textit{Young Supernova Experiment} [\myhref{https://yse.ucsc.edu/}{Link}] \hspace*{\fill} 10/2022 -- pres
\vspace{0.2cm}
...
\item \href{https://benjaminleroy.github.io/}{Benjamin LeRoy} (UC Berkeley), Summer Undergraduate Research Experience in Statistics [\myhref{https://www.stat.cmu.edu/summer/}{Link}], Carnegie Mellon University, Summer 2015. ``Dynamical Mass Measurements of Galaxy Clusters.'' (Received Ph.D. in Statistics \& Data Science from CMU in 2021).
\end{itemize}
\end{itemize}
...
\begin{itemize}[leftmargin=0.4cm, itemsep=0.2cm]
\item Postdoc representative on the Teaching Committee\hspace*{\fill}10/2022 -- pres\\
Institute of Astronomy, University of Cambridge. 
\item Member of the Postdoc Committee\hspace*{\fill}01/2023 -- pres\\
Institute of Astronomy, University of Cambridge.
\end{itemize}
...
%{\it Using Statistics to Explore the Universe}, Hillel Academy of Pittsburgh, AP Statistics. \hspace*{\fill}2017
...
\begin{equation*}
    \hspace{-0.5cm}\begin{array}{L@{\hspace{0.75cm}}L}
      ...
      {\bf RAS} & \textit{Royal Astronomical Society} 
      \end{array}
\end{equation*}
