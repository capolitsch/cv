...
\textbf{\Large Collin A. Politsch} & \textnormal{\today} \\
\end{tabular*}
...
{\justify
\begin{itemize}[leftmargin=0.4cm, rightmargin=0.5cm]
...
\item[] {\bf Astrophysics:} Astrostatistics and astroinformatics, cosmostatistics, nonparametric and data-driven astrophysics, Lyman-$\alpha$ forest, intergalactic medium, statistical cosmography, large-scale structure of the Universe, planetary transits%, time-domain astronomy, spectroscopic classification and redshift estimation
\end{itemize}}
\vspace{0.1cm}
...
\item[] \subheadingtwo{Flatiron Institute\textnormal{, Center for Computational Astrophysics}}{New York, NY}{\emph{Guest Researcher}}{August 2021 - present}

\item[] \subheadingtwo{Carnegie Mellon University\textnormal{, Machine Learning Department}}{Pittsburgh, PA}{\emph{Postdoctoral Fellow}}{July 2020 - July 2021}
...
\item[] \subheadingtwo{Carnegie Mellon University}{Pittsburgh, PA}{Joint Ph.D. in Statistics and Machine Learning}{2020}
\vspace{-0.35cm}
\begin{enumerate}
	\item[] \hspace{-2ex}Dissertation: {\it Statistical Astrophysics: From Extrasolar Planets to the Large-scale}\\
	\vspace{-.05cm}
	\hspace{11.17ex}{\it Structure of the Universe}
	\vspace{-.05cm}
	\item[] \hspace{-2ex}Award: 2020-'21 Umesh K. Gavaskar Memorial Award for Best Ph.D. Dissertation
	\vspace{-.05cm}
...
\item[] \subheadingtwo{Carnegie Mellon University}{Pittsburgh, PA}{M.Sc. in Machine Learning}{2017}
\vspace{-0.35cm}
\begin{enumerate}
...
\item[] \subheadingtwo{University of Kansas}{Lawrence, KS}{B.Sc. in Mathematics (With Honors)}{2014}
\vspace{-0.35cm}
\begin{enumerate}
...
\begin{enumerate}
\item \textbf{Three-dimensional cosmography of the high redshift Universe using intergalactic absorption} 
\vspace{-0.6cm}
\item[] \underline{Collin A. Politsch}, Jessi Cisewski-Kehe, Rupert A.C. Croft, Larry Wasserman
\vspace{-0.25cm}
\item[] {In preparation. Pre-submission inquiry approved by \emph{Nature}}.

\item \textbf{Trend Filtering -- I. A Modern Statistical Tool for Astronomical Spectroscopy and Time-Domain Astronomy}
\vspace{-0.25cm}
\item[] \underline{Collin A. Politsch}, Jessi Cisewski-Kehe, Rupert A.C. Croft, Larry Wasserman
\vspace{-0.25cm}
\item[] {{\it Monthly Notices of the Royal Astronomical Society}}, Volume 492, Issue 3, March 2020, Pages 4005-4018. \href{https://doi.org/10.1093/mnras/staa106}{Publisher}. \href{https://arxiv.org/abs/1908.07151}{arXiv}. \href{https://capolitsch.github.io/trendfiltering}{GitHub}.
\vspace{-0.05cm}
\begin{itemize}
...
\item[] \underline{Collin A. Politsch}, Jessi Cisewski-Kehe, Rupert A.C. Croft, Larry Wasserman
\vspace{-0.25cm}
\item[] {{\it Monthly Notices of the Royal Astronomical Society}}, Volume 492, Issue 3, March 2020, Pages 4019-4032. \href{https://doi.org/10.1093/mnras/staa110}{Publisher}. \href{https://arxiv.org/abs/2001.03552}{arXiv}. \href{https://capolitsch.github.io/trendfiltering}{GitHub}.
\vspace{-0.05cm}
\begin{itemize}
\item[$\boldsymbol{\ast}$]{\bf Finalist for best paper in the 2020 ASA Astrostatistics Student Paper Competition}, sponsored by the Astrostatistics Interest Group.
\end{itemize}
...
%\item \textbf{The United States COVID-19 Forecast Hub dataset} 
%\vspace{-0.25cm}
%\item[] Estee Y. Cramer, Yuxin Huang, Yijin Wang, et al.
%\vspace{-0.25cm}
%\item[] Preparing to submit to \emph{Scientific Data - Nature}.
%\vspace{0.15cm}
...
-- {\it Into the Impossible With Brian Keating}, \href{https://www.youtube.com/watch?v=jpD_4S7Wi3E&t=2123s}{YouTube Link}, Aug. 2021. \\

\vspace{-0.4cm}

-- University of Chicago, Machine Learning in Complex Phenomena, Chicago, IL. Feb. 2021.\\

\vspace{-0.4cm}

-- University of Maryland, Department of Mathematics, College Park, MD. Nov. 2020.\\

\vspace{-0.4cm}

-- Duke University, Department of Statistical Science, Durham, NC. Nov. 2020.\\

\vspace{-0.4cm}

-- NSF AI Planning Institute: Physics of the Future \& STAMPS@CMU. Oct. 2020.\\

\vspace{-0.4cm}

-- Flatiron Institute, Center for Computational Astrophysics \& NYU. Oct. 2020.\\

\vspace{-0.4cm}

-- Los Alamos National Laboratory, Los Alamos, NM. Oct. 2020. 
...
-- SAMSI Astronomy Transition Workshop, Durham, NC. May 2017.
...
-- Statistical and Applied Mathematical Sciences Institute, Durham, NC. April 2017.
...
\item[] R package \texttt{trendfiltering}: \emph{The state-of-the-art method for denoising 1D signals.}
\vspace{-0.05cm}

\hspace{4ex} Available at \url{https://capolitsch.github.io/trendfiltering}

\item[] R package \texttt{SALTdenoiseR}: \emph{Statistical software for the SALT Observatory.} 
\vspace{-0.05cm}

\hspace{4ex} Available at \url{https://capolitsch.github.io/SALTdenoiseR}

\item[] R package \texttt{aardvark}: \emph{COVID-19 forecasters from Carnegie Mellon's Delphi research group.} 
\vspace{-0.05cm}

\hspace{4ex} Available at \texttt{\href{https://github.com/cmu-delphi/covid-19-forecast/tree/main/forecasters/aardvark}{https://github.com/cmu-delphi/covid-19-forecast}}

\item[] R package \texttt{trendfilteringSupp}: \emph{Optimal one-dimensional data analysis with trend filtering.} 
\vspace{-0.05cm}

\hspace{4ex} Available at \url{https://github.com/capolitsch/trendfilteringSupp}
...
\begin{enumerate}
	\setlength\itemsep{-0.05ex}
	\item[] Undergraduate student: Benjamin Leroy (UC Berkeley; now CMU PhD student)
...
\begin{addmargin}[0.25cm]{2em}
{\bf AAS}
\hspace{7.5ex}{\it American Astronomical Society} \\
{\bf ASA}
\hspace{7.5ex}{\it American Statistical Association} \\
{\bf COIN}
\hspace{5.75ex}{\it Cosmostatistics Initiative} \\
{\bf IAA} 
\hspace{7.1ex}
{\it International Astrostatistics Association} \\
{\bf IAIA}
\hspace{6.875ex}{\it International AstroInformatics Association} 
\end{addmargin}
...
\begin{itemize}
%\item[--]\MYhref[blue]{https://www.technologyreview.com/2021/05/28/1025478/covid-ensemble-model-forecast-trustworthy/}{{\it All together now: the most trustworthy covid-19 model is an ensemble}}, MIT Technology Review
%\vspace{-.15cm}
