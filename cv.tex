...
\item[] \hspace{-2ex}\subheadingtwolines{{\bf Flatiron Institute}, Center for Computational Astrophysics}{New York, NY}{{\it Guest Researcher}}{August 2021 -- present}
\item[] \hspace{-2ex}\subheadingtwolines{{\bf Carnegie Mellon University}, Machine Learning Department}{Pittsburgh, PA}{\emph{Postdoctoral Fellow}, Supervisor: Ryan J. Tibshirani}{July 2020 -- July 2021}
\end{itemize}
\vspace{-0.25cm}
...
\begin{itemize}[leftmargin=0.225cm, itemsep=-0.05cm]
...
\begin{itemize}[leftmargin=0.4cm]
\item[] \hspace{-2ex}\subheadingtwolines{\bf Carnegie Mellon University}{}{\it Graduate Teaching Assistant}{January 2015 -- December 2018}
...
\item[] \hspace{-2ex}\subheadingoneline{\it Research Advisor}{May 2015 -- August 2015}

\begin{enumerate}[itemsep=-0.05ex,leftmargin=0.4cm]
	\item[] Undergraduate student: Benjamin Leroy (received Ph.D. in Statistics \& Data Science from CMU in 2021)
	\item[] Project: Dynamical Mass Measurements of Galaxy Clusters
	\item[] Award: NSF Grant \href{https://www.nsf.gov/awardsearch/showAward?AWD_ID=1043903&HistoricalAwards=false}{\#1043903}
\end{enumerate}
